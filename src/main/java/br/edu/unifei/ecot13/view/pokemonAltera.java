...
public class pokemonAltera extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					pokemonAltera frame = new pokemonAltera();
	...
	public pokemonAltera() {
		...
		JLabel lblTitle = new JLabel("Change Your Pokemon");
		...
		btnChange.setBounds(139, 195, 85, 21);
		...
		btnFind.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(pokemon!=null) {
					...
					spnHealth.setEnabled(true);
					spnDefense.setEnabled(true);
